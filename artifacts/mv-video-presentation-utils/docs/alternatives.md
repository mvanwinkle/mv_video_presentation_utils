...
update-alternatives --install \
	/usr/bin/mv-video-presentation-utils_hello \
	mv-video-presentation-utils_hello \
	/opt/IAS/bin/mv-video-presentation-utils/mv-video-presentation-utils_hello.sh 50
```
...
update-alternatives --remove \
	mv-video-presentation-utils_hello \
	/opt/IAS/bin/mv-video-presentation-utils/mv-video-presentation-utils_hello.sh
```
